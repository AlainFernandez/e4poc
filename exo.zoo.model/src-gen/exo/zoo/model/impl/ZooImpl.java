 ...
 * </p>
 * <ul>
 *   <li>{@link exo.zoo.model.impl.ZooImpl#getName <em>Name</em>}</li>
 *   <li>{@link exo.zoo.model.impl.ZooImpl#getParc <em>Parc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZooImpl extends MinimalEObjectImpl.Container implements Zoo {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ZOO;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ZOO__NAME, oldName, name));
	}
	...
	public EList<Parc> getParc() {
		if (parc == null) {
			parc = new EObjectContainmentEList<Parc>(Parc.class, this, ModelPackage.ZOO__PARC);
		}
		return parc;
	}
