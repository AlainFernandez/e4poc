 ...
 * @generated
 */
public class MTableImpl extends MinimalEObjectImpl.Container implements Table {
	/**
	...
	protected EClass eStaticClass() {
		return MPizzeriaPackage.Literals.TABLE;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MPizzeriaPackage.TABLE__ID, oldId, id));
	}
